...
public class JogoCenario extends CenarioPadrao {
    ...
    protected JLabel pontuacaoLabel;
    ...
    public void atualizar() {
        ...
        validaPosicao(direita);
            ...
            if (pontoB.getPonto() - pontoA.getPonto() >= 1 || pontoA.getPonto() - pontoB.getPonto() >= 1) {
    ...
    public void desenhar(Graphics2D g) {
        ...
        if (Jogo.pausado) textoPausa.desenha(g, "PAUSA", largura / 2 - Ponto.TAMANHO_FONTE, altura / 2);
    ...
    public void rebate(Elemento raquete, Bola bola) {
        ...
        double valor = Math.toDegrees(angulo);
